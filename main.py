...
parser.add_argument('--dataset', type=str, default='mosei_senti',
                    help='dataset to use (default: mosei_senti)/mosi')
# Tasks
...
parser.add_argument('--name', type=str, default='gaussion',
...
if __name__ == '__main__':
    '''
        Due to file size limitation, the datasets please refer to 
...
#       .format(acc7, acc2, f_score, mae, corr))
# print("****************************************************")
# print("****************************************************")
